...
def calculates_results_stats(results_dic):
    ...
    # this function 
    results_stats_dic = {'n_images': 0, 'n_dogs_img': 0, 'n_notdogs_img': 0, 'n_match': 0, 'n_correct_dogs': 0, 'n_correct_notdogs': 0, 'n_correct_breed': 0, 'pct_match': 0.0, 'pct_correct_dogs': 0.0, 'pct_correct_notdogs': 0.0, 'pct_correct_breed': 0.0}
    ...
    results_stats_dic['pct_match'] = (results_stats_dic['n_match'] / n_images) * 100 if n_images > 0 else 0
