...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
      ...
      classifier_label = classifier(image_path, model).lower().strip() #run classifier to get the label  #format the classifier label (same as the pet labels)
      results_dic[key].append(classifier_label) #append the label to the results dic
